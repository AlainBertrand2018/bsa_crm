        ...
        .then(data => {
          if (data) {
            const transformedData: Invoice = {
              ...
              clientPhone: data.clients?.client_phone || data.clientPhone,
              clientAddress: data.clients?.client_address || data.clientAddress,
              clientBRN: data.clients?.client_brn || data.clientBRN,
